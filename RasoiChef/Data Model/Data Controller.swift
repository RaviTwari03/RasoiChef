...
//        ),
    ...
    static var subscriptionPlan: [SubscriptionPlan] = [
        SubscriptionPlan(
            ...
            weeklyMeals: [
                .monday: [
                    .breakfast: subscriptionMenuItem.first(where: { $0.itemID == "item201" }),
                    .lunch: subscriptionMenuItem.first(where: { $0.itemID == "item101" }),
                    .snacks: subscriptionMenuItem.first(where: { $0.itemID == "item301" }),
                    .dinner: subscriptionMenuItem.first(where: { $0.itemID == "menu001" })
                ],
                .tuesday: [
                    .breakfast: subscriptionMenuItem.first(where: { $0.itemID == "item202" }),
                    .lunch: subscriptionMenuItem.first(where: { $0.itemID == "item102" }),
                    .snacks: subscriptionMenuItem.first(where: { $0.itemID == "item302" }),
                    .dinner: subscriptionMenuItem.first(where: { $0.itemID == "item401" })
                ],
                .wednesday: [
                    .breakfast: subscriptionMenuItem.first(where: { $0.itemID == "item203" }),
                    .lunch: subscriptionMenuItem.first(where: { $0.itemID == "item103" }),
                    .snacks: subscriptionMenuItem.first(where: { $0.itemID == "item303" }),
                    .dinner: subscriptionMenuItem.first(where: { $0.itemID == "item402" })
                ],
                .thursday: [
                    .breakfast: subscriptionMenuItem.first(where: { $0.itemID == "item204" }),
                    .lunch: subscriptionMenuItem.first(where: { $0.itemID == "item104" }),
                    .snacks: subscriptionMenuItem.first(where: { $0.itemID == "item304" }),
                    .dinner: subscriptionMenuItem.first(where: { $0.itemID == "item403" })
                ],
                .friday: [
                    .breakfast: subscriptionMenuItem.first(where: { $0.itemID == "item205" }),
                    .lunch: subscriptionMenuItem.first(where: { $0.itemID == "item105" }),
                    .snacks: subscriptionMenuItem.first(where: { $0.itemID == "item305" }),
                    .dinner: subscriptionMenuItem.first(where: { $0.itemID == "item404" })
                ],
                .saturday: [
                    .breakfast: subscriptionMenuItem.first(where: { $0.itemID == "item206" }),
                    .lunch: subscriptionMenuItem.first(where: { $0.itemID == "item106" }),
                    .snacks: subscriptionMenuItem.first(where: { $0.itemID == "item306" }),
                    .dinner: subscriptionMenuItem.first(where: { $0.itemID == "item405" })
                ],
                .sunday: [
                    .breakfast: subscriptionMenuItem.first(where: { $0.itemID == "item207" }),
                    .lunch: subscriptionMenuItem.first(where: { $0.itemID == "item107" }),
                    .snacks: subscriptionMenuItem.first(where: { $0.itemID == "item307" }),
                    .dinner: subscriptionMenuItem.first(where: { $0.itemID == "item406" })
                ]
            ]
        )
    ]
...
//    }
    ...
    static var subscriptionMenuItem : [MenuItem] = [
